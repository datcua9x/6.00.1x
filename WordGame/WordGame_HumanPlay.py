...
HAND_SIZE = random.randrange(7,15)
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if word == '.':
            print("Goodbye!" + ".Total score", total)
            break
        if not isValidWord(word, hand, wordList):
            print("Invalid word, please try again")
        if isValidWord(word, hand, wordList):
            total += getWordScore(word, n)
            print(word, "earned", getWordScore(word, n), ".Total score", total)
            hand = updateHand(hand, word)
        if calculateHandlen(hand) == 0:
            print("\n""Run out of letters" + ".Total score", total)
            break
...
def playGame(wordList):
    ...
    while True:
        ...
        if choice == 'n':
            ...
            playHand(hand, wordList, len(hand))
            newhand = hand.copy()
        elif choice == 'r':
            if newhand == {}:
